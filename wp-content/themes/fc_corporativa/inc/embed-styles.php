...
function include_styles() {
  wp_enqueue_style('fc_corporativa-bs-css', get_template_directory_uri() . '/dist/css/bootstrap.min.css' );
  ...
  wp_enqueue_style('style-grid-boxes', get_template_directory_uri() . '/dist/css/style-grid-boxes.css' );
  wp_enqueue_style('style-grid-full', get_template_directory_uri() . '/dist/css/style-grid-full.css' );
